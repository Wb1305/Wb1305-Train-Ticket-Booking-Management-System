...
void menuTimKiem()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            cin.ignore();
            string name;
            cout << "\n \t \t Nhap ten hanh khach muon tim kiem: ";
            getline(cin, name);
            HanhKhach hk[M];
            int size = 0;
        ...
        case 2:
        {
            ...
            cin.ignore();
            string id;
            cout << "\n \t \t Moi ban nhap id ve tau can tim: ";
            getline(cin, id);
            VeTau vt[M];
            int size = 0;
            DocDuLieu_VeTau(vt, size);
...
void menuThongKe()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            int size = 0;
            DocDuLieu_VeTau(vt, size);
            double doanh_thu = DoanhThuVeThuong(vt, size);

            cout << "\n \t Doanh thu ve thuong la: " << doanh_thu << endl;
            break;
        }
        case 2:
        {
            ...
            int size = 0;
            DocDuLieu_VeTau(vt, size);
            double doanh_thu = DoanhThuVeVip(vt, size);
...
void menuRole()
{
    ...
    do
    {
        ...
        cout << "\n \t 0. Exit";
        cout << "\n \t \t Vui long chon chuc nang cua ban: ";
        cin >> role;
